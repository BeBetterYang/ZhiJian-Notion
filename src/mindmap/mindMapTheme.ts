...
export const MIND_MAP_THEME_PRESETS: readonly MindMapTheme[] = [
  {
    ...
    level1: nodeStyle("transparent", "#181818", "transparent", "0px"),
    child: nodeStyle("transparent", "#202020", "transparent", "4px"),
  ...
  },
  {
    ...
    branchPalette: ["#b8babd"],
    level1: nodeStyle("transparent", "#181818", "transparent", "0px"),
    child: nodeStyle("transparent", "#202020", "transparent", "0px"),
    connector: { color: "#b8babd" },
